...
Do not expose this analysis unless `audit` was requested. Read [references/intent-ir.md](references/intent-ir.md) only for a complex self-correction, `grounded`, or `audit` request.
